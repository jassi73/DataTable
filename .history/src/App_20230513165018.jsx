  ...
  const columns = [
    ...
    },
    {
      ...
      selector:row=> row.mass,
        ...
        return (
            <div>
            <div style={{display: 'flex' , width:"982px"}}>
<h5 style={{width: '7%'}}>Users List</h5>
           <InputBox value={searchQuery} placeholder="Search the User" onChange={(e)=> setSearchQuery(e.target.value)}/>
            </div>
                <Datatable
                    selectableRows
                    fixedHeader={true}
